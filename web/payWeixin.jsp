				...
				<div class="panel panel-default"  style="margin: 0 auto;width: 95%;">
				  <div class="panel-heading">
				    <h3 class="panel-title"><span class="glyphicon glyphicon-yen"></span>&nbsp;&nbsp;在线支付
				    	<span class="pull-right"><a href="order.do?method=showMineList">返回订单列表</a>
				    	</span>
				    </h3>
				  </div>
				  <div class="panel-body">	 
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control" name="body" value="收货人：${param.name}">
							<!-- 设置 程序回传到的链接地址 -->
								<%--order.do?method=success--%>
							<input type="hidden" class="form-control" name="url" value="http://localhost:8080/test02/pay.do?method=pay&oid=${param.oid}">
							</td>
						</tr>
