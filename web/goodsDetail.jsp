		...
		<div class="row">
		  <div class="col-xs-6 col-md-6">
		    <a href="#" class="thumbnail">
		      <img src="${product.pimage}"  width="560" height="560"  alt="${product.pname}" />
		    </a>
		  </div>
		  <div class="col-xs-6 col-md-6">
			  ...
			  <div class="panel-body">
			    ...
			    <div style="margin-left: 10px;">
				   ...
				   <p>市场价格:&nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 15px;">${product.pprice}</span>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-yen"></span></p>
				    ...
				    <p>详细介绍:</p>
				    <p>&nbsp;&nbsp;${product.pinfo }</p>
				    <a href="cart.do?method=create&pid=${product.pid}" class="btn btn-warning">加入购物车&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
				    <button class="btn btn-danger" id="buynow">直接购买</button>
			    </div>
			  </div>
			</div>
		  </div>
...
<script>
	$(function () {
	  $("#buynow").click(function () {
		$("#buynow").attr("src","order.do?method=buyNow&pid="+${product.pid})
      })
    })
</script>