		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","typetodo.do?method=getGoodsType");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","admin/addGoodsType.jsp");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","goodtodo.do?method=getGoodsList");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","goodtodo.do?method=preAdd");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","admin.do?method=showAOrder");
				})
			</script>
