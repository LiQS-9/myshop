...
<title>无效会员管理</title>
	<script type="text/javascript">
      ...
      function loadUser(){
        $.ajax({
          url:"usertodo.do?method=getInvalidUserList",
          method:"get",
      ...
      function showMsg(data){
        ...
        for(var u in list){
          ...
          var td5 = $("<td>"+(list[u].urole==0?"管理员":"会员")+"</td>");
      ...
      function delUser(id){
        if(confirm("确认要删除吗?")){
          $.ajax({
            url:"usertodo.do?method=delUser&id="+id,
            method:"get",
            success:function(data){
              loadUser();
            },
      ...
      $(function(){
        ...
        $("#search").click(function(){
          ...
          //使用ajax 进行异步交互
          $.ajax({
            url:"usertodo.do?method=searchUser&username="+username+"&gender="+gender,
            method:"post",
            success:function(data){
              if(data==0){
                alert("未找到指定内容");
