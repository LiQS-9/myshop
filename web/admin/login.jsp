...
<div id="main" class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<form action="admin.do?method=adminLogin" method="post">
			<div class="form-group">
				<label>用户名:</label>
				<input type="text" name="username" value="q" id="" class="form-control" placeholder="请输入用户名"/>
			</div>
			<div class="form-group">
				<label>密&nbsp;&nbsp;&nbsp;码:</label>
				<div class="input-group">
					<input type="password" name="password" value="q" id="password" class="form-control"  placeholder="请输入密码"/>
