...
<script type="text/javascript">
	...
	function sub(cid,cnum,price){
		...
		if (cnum == 1){
			...
			{
				location.href = "cart.do?method=delete&cid="+cid;
			}
		}else{
			cnum--;
			  // $.ajax({
				// url:"cart.do?method=update&cid="+cid+"&cnum="+cnum+"&price="+price,
				// type:"POST",
				// dataType:"json",
				// success:function (data) {
				//   console.log(data);
				// 	// 更改小计的值
				//   $("#xiaoji").innerText(data.getItemIndex())
				// }
			  // })
			location.href = "cart.do?method=update&cid="+cid+"&cnum="+cnum+"&price="+price;
		}
	...
	function clearCart(uid){
		...
		{
		  if(uid!=0)
			location.href = "cart.do?method=clear&uid="+uid;
		}
	}
</script>
</head>
	...
	<div class="row">
		<div class="pull-right" style="margin-right: 40px;">
	            ...
	            <div>
	            	...
	            	&nbsp;&nbsp;
	            	<a href="order.do?method=preView&uid=${loginUser.uid}" class="btn  btn-danger btn-lg">立即下单</a>
